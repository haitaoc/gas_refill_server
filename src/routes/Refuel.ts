...
router.get('/user/:userId/refuels', async (req: Request, res: Response) => {
...
router.post('/', async (req: Request, res: Response) => {
    ...
    try {
        ...
        let refuel = new Refuel(jsonData.username, jsonData.vehicleNickname, jsonData.date, jsonData.gasPrice, jsonData.amountPaid, jsonData.curMileage);
